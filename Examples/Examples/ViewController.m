...
- (IBAction)checkout:(id)sender
{
    ...
    AffirmCheckoutMetadata *metadata = [AffirmCheckoutMetadata checkoutMetadataWithShippingType:@"UPS Ground" entityName:@"internal-sub_brand-name" webhookSessionId:@"ABC123"];
