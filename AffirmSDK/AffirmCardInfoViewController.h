...
/**
 The credit card object used to render card info page.
 */
@property (nonatomic, strong, readonly) AffirmCreditCard *creditCard;
...
NS_SWIFT_NAME(startNavigation(checkout:creditCard:getReasonCodes:delegate:));
