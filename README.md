...
2. In the next page, specify the version resolving rule as "Up to Next Major" with "5.0.25".
...
```swift
dependencies: [
    .package(url: "https://github.com/Affirm/affirm-merchant-sdk-ios", .upToNextMajor(from: "5.0.25"))
]
```
